...
@section('content')
    ...
    <!-- set rights -->
    <div id="set_rights" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="set_rights_form" action="{{ url('set_rights') }}" method="post">
                        {{ csrf_field() }}
                        <input type="hidden" id="set_rights_id" name="set_rights_id" value="0">
                        <div class="form-group">
                            <label for="sel1">Select New Right For The Category:</label>
                        ...
                        <div class="form-group">
                            <label class="checkbox-inline"><input type="checkbox" name="sub_cat" id="sub_cat" value="sub_cat">Apply to subcategories</label>
                        </div>
                        <button type="submit" id="submit_set_rights" class="btn btn-default">Submit</button>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
    ...
    <div class="container">
        <div class="text-left">
            <input type="hidden" id="navigation" value="admin">
            <!-- category panel -->
            <div class="cat-manager content">
                ...
                <div class="text-right">
                    <h3>
                        ...
                        <a href="#modal" class="log" data-toggle="modal" data-target="#set_rights"><i class="fa fa-cog" aria-hidden="true"></i></a>
                    </h3>
                </div><!-- end icons -->
